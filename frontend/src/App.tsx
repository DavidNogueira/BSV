  ...
  useEffect(() => {
    const fetchFriendIdentity = async () => {
      try {
        ...
        const { publicKey: initialIdentity } =
          await walletClientInstance.getPublicKey({
            identityKey: true
          })
        if (!initialIdentity) {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      ...
      >
        ...
        <ol>
          <li>
            <strong>Prerequisites:</strong> Ensure Metanet client is running
            with both "default" and "friend" profiles configured. You will
            switch between these profiles for Tests 3 and 7.
          </li>
          <li>
          ...
          <li>
            ...
            (Test 7), then switching back to "default". Complete the
            switchProfile TODOs in cryptionManager.ts and uncomment the
            profile-switching code in this file and index.tsx.
          </li>
          <li>
